---
title: Importing TLS certificates to Che server Java truststore
keywords:
tags: []
sidebar: che_7_docs
permalink: che-7/importing-tls-certificates-to-che-server-java-truststore
redirect_from:
  - che-7/mounting-custom-tls-certificates-to-che-workspace-pods
...
[id="adding-custom-tls-certificates-to-{prod-id-short}-workspace-pods_{context}"]
